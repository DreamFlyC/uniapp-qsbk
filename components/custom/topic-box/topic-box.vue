<template>
	<view class="topic-box">
		...
		<view class="topic-media">
			<image :src="item.mediaInfo.titlePic" mode="widthFix" lazy-load></image>
		...
		<view class="topic-operation uni-flex-sbc">
			<view class="uni-flex-c">
				<view class="uni-flex-c">
					<view class="iconNum icon iconfont icon-icon_xiaolian-mian" :class="{ active: item.operInfo.flag === 1 }" @click="onSmileClick(item.operInfo.flag)"></view>
			...
			<view class="uni-flex-right" style="margin-right: 0;">
				<view class="uni-flex-c">
					<view class="iconNum icon iconfont icon-pinglun1"></view>
